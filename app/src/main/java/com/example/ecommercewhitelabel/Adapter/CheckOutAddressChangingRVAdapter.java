...
public class CheckOutAddressChangingRVAdapter  extends RecyclerView.Adapter<CheckOutAddressChangingRVAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public CheckOutAddressChangingRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = null;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.checkout_address_recycler_item_layout,parent,false);
        return new CheckOutAddressChangingRVAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CheckOutAddressChangingRVAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
